...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Furniture`.`color_detail` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Furniture`.`details` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `x` INT NOT NULL,
  `y` INT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_details_color_detail1_idx` (`color_detail_id` ASC),
  INDEX `fk_details_edge_material1_idx` (`edge_material_id` ASC),
  CONSTRAINT `fk_details_color_detail1`
    FOREIGN KEY (`color_detail_id`)
    REFERENCES `Furniture`.`color_detail` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Furniture`.`facade` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `facade_type` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Furniture`.`lifts` (
  ...
  `name_manufacture` VARCHAR(45) NOT NULL,
